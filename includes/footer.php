    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
         ...
         <div class="col-md-3 col-sm-6">
          <h6>Who we Are</h6>
          <p class="whoweare-text">At Unlimited Biking, we believe that the best biking experience is one that encompasses quality bikes, great customer service, and the desire to explore. We’ve been dedicated to sharing our passion for biking for over ten years.</p>
        </div>
<div class="col-md-3 col-sm-6">
          <h6>Who we Are</h6>
          <p class="whoweare-text">At Unlimited Biking, we believe that the best biking experience is one that encompasses quality bikes, great customer service, and the desire to explore. We’ve been dedicated to sharing our passion for biking for over ten years.</p>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; 2021 MOTOCYCLE. ALL RIGHTS RESERVED  <a href="https://www.grex-conseil.com/">GREX</a></p>
        </div>
      </div>
    </div>
  </div>
