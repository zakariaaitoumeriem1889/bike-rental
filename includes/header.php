        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">exemple@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Service Help Line Call Us: </p>
              <a href="tel:+999079373999">+999079373999</a> </div>
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="tour-listing.php">Tour Listing</a>
          <li><a href="page.php?type=faqs">FAQs</a></li>
          <li><a href="page.php?type=annonce">Announcement</a></li>
