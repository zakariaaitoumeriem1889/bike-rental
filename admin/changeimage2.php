...
$sql="update tblmotors set Vimage2=:vimage where id=:id";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Motor Image 2 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Motor Image 2 Details</div>
...
<?php
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage2 from tblmotors where tblmotors.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
