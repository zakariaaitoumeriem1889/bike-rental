...
?>
													...
													<div class="stat-panel-title text-uppercase">Listed Bikes</div>
												</div>
											</div>
...
<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
<?php
$sql3 ="SELECT id from tbltours ";
$query3= $dbh -> prepare($sql3);
$query3->execute();
$results3=$query3->fetchAll(PDO::FETCH_OBJ);
$tours=$query3->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($tours);?></div>
													<div class="stat-panel-title text-uppercase">Listed Tours</div>
												</div>
											</div>
											<a href="manage-brands.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
