...
move_uploaded_file($_FILES["img1"]["tmp_name"],"img/toursimages/".$_FILES["img1"]["name"]);
move_uploaded_file($_FILES["img2"]["tmp_name"],"img/toursimages/".$_FILES["img2"]["name"]);
move_uploaded_file($_FILES["img3"]["tmp_name"],"img/toursimages/".$_FILES["img3"]["name"]);
move_uploaded_file($_FILES["img4"]["tmp_name"],"img/toursimages/".$_FILES["img4"]["name"]);
$tourincludes=$_POST['tourincludes'];
$id=intval($_GET['id']);

$sql="INSERT INTO tbltours(tname,duration,tbrand,toverview,tprice,t_img1,t_img2,t_img3,t_img4,tincludes) VALUES(:tourname,:tduration,:tourbrand,:touroverview,:price,:image1,:image2,:image3,:image4,:tourincludes)";
...
<head>
	...
	<title>Bike Rental Portal | Admin Post Tour</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Post A Tour</h2>
...
<div class="col-sm-4">
<input type="text" name="tduration" class="form-control" required>
</div>
...
<div class="col-sm-10">
<textarea class="form-control" name="touroverview" rows="3" required></textarea>
</div>
</div>
...
<div class="hr-dashed"></div>
<div class="form-group">
<label class="col-sm-2 control-label">Tour Includes<span style="color:red">*</span></label>
<div class="col-sm-10">
<textarea class="form-control" name="tourincludes" rows="3" required></textarea>
</div>
</div>
</div>
