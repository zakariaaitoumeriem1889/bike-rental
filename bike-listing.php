...
<?php $sql = "SELECT tblmotors.*,tblbrands.BrandName,tblbrands.id as bid  from tblmotors join tblbrands on tblbrands.id=tblmotors.MotorsBrand";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
<option value="Bike">BIKE</option>
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul>
<?php $sql = "SELECT tblmotors.*,tblbrands.BrandName,tblbrands.id as bid  from tblmotors join tblbrands on tblbrands.id=tblmotors.MotorsBrand order by id desc limit 4";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->MotorsTitle);?></a>
